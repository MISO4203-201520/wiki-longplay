...
###### Matriz de Requerimeintos

|          Id          |         Nombre Breve         |                       Views                       |               Ctlrs               |                   Srvs                    |       Pruebas Selenium       |                      Servicios Rest                      |  Pruebas Servicios   |                     DTO                      |                          Lógica (Interfaz y EJB)                          |                Entity                 |                 Converters                  |                   Persistence                   |               Pruebas Lógica                |                  Pruebas Persistencia                   |
|----------------------|------------------------------|---------------------------------------------------|-----------------------------------|-------------------------------------------|------------------------------|----------------------------------------------------------|----------------------|----------------------------------------------|---------------------------------------------------------------------------|---------------------------------------|---------------------------------------------|-------------------------------------------------|---------------------------------------------|---------------------------------------------------------|
| R1                   | Medios de Pago               | shoppingCart.tpl.html                             | cartItem.ctrl.js                  | cartItem.svc.js                           |                              | CartItemService.java                                     |                      | CartItemDTO.java                             | "ICartItemLogic.java                                                      |                                       |                                             |                                                 |                                             |                                                         |
| CartItemLogic.java"  | CartItemEntity.java          | CartItemCoverter.java                             | CartItemPersistence.java          | CartItemTest.java                         | CartItemPersistenceTest.java |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R2                   | Comentarios                  | catalog.tpl.html                                  | catalog.ctrl.js                   | comment.svc.js                            |                              | CommentService.java                                      |                      | CommentDTO.java                              | "ICommentLogic.java                                                       |                                       |                                             |                                                 |                                             |                                                         |
| CommentLogic.java"   | CommentEntity.java           | CommentConverter.java                             | CommentPersistence.java           | CommentLogicTest.java                     |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R3                   | Usuarios y Roles (shiro.ini) | index.html                                        | provider.ctrl.js                  | user.svc.js client.svc.js                 |                              | UserService.java ClientService.java                      |                      | UserDTO.java ClientDTO.java ProviderDTO.java | IClientLogic.java ClientLogic.java IProviderLogic.java ProviderLogic.java | ClientEntity.java ProviderEntity.java | ClientConverter.java ProviderConverter.java | CrudPersistence.java                            | ClientLogicTest.java ProviderLogicTest.java | ClientPersistenceTest.java ProviderPersistenceTest.java |
| R4                   | Preguntas                    | "catalog.tpl.html                                 |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| question.tpl.html"   | catalog.ctrl.js              | question.svc.js                                   |                                   | QuestionService.java                      |                              | QuestionDTO.java                                         | "IQuestionLogic.java |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| QuestionLogic.java"  | QuestionEntity.java          | QuestionConverter.java                            | QuestionPersistence.java          | QuestionLogicTest.java                    | QuestionPersistenceTest.java |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R5                   | Búsqueda más Barato          | catalog.tpl.html                                  | catalog.ctrl.js                   | longPlay.svc.js                           |                              | LongPlayService.java                                     |                      |                                              | "ILongPlayEntity.java                                                     |                                       |                                             |                                                 |                                             |                                                         |
| LongPlayEntity.java" | LongPlayEntity.java          |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R6                   | Agregar Descuento            | catalog.tpl.html                                  | catalog.ctrl.js                   | longPlay.svc.js                           |                              | LongPlayService.java                                     |                      | LongPlayDTO.java                             |                                                                           | LongPlayEntity.java                   | LongPlayConverter.java                      |                                                 |                                             |                                                         |
| R7                   | Escuchar Canción             | catalog.tpl.html                                  | song.ctrl.js                      | song.svc.js                               |                              | SongService.java                                         |                      | SongDTO.java                                 | "ISongLogic.java                                                          |                                       |                                             |                                                 |                                             |                                                         |
| SongLogic.java"      | SongEntity.java              | SongConverter.java                                | SongPersistence.java              | SongLogicTest.java                        | SongPersistenceTest.java     |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R8                   | Información Catalogo         | catalog.tpl.html                                  | song.ctrl.js                      | "question.svc.js                          |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| song.svc.js"         |                              | SongService.java                                  |                                   | "LongPlayDTO.java                         |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| QuestionDTO.java     |                              |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| QuestionDTO.java"    | "ISongLogic.java             |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| SongLogic.java"      | "LongPlayEntity.java         |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| SongEntity.java"     | "LongPlayConverter.java      |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| SongConverter.java"  | SongPersistence.java         | AlbumLogicTest.java                               | AlbumPersistenceTest.java         |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
| R10                  | Administración Usuarios      | catalog.tpl.html shoppingCart.tpl.html index.html | cartItem.ctrl.js purchase.ctrl.js | user.svc.js client.svc.js provider.svc.js |                              | UserService.java ClientService.java ProviderService.java |                      | UserDTO.java ClientDTO.java ProviderDTO.java | IClientLogic.java ClientLogic.java IProviderLogic.java ProviderLogic.java | ClientEntity.java ProviderEntity.java | ClientConverter.java ProviderConverter.java | ClientPersistence.java ProviderPersistence.java | ClientLogicTest.java ProviderLogicTest.java | ClientPersistenceTest.java ProviderPersistenceTest.java |
| R11                  | Consultar Ordenes de Pedido  |                                                   |                                   |                                           |                              |                                                          |                      |                                              |                                                                           |                                       |                                             |                                                 |                                             |                                                         |
